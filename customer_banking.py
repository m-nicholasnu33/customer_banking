...
def main():
    ...
    # ADD YOUR CODE HERE
    print(f"Your interest earned on the savings account is: {savings_interest_earned:,.2f}")
    ...
    # ADD YOUR CODE HERE
    print(f"Your interest earned on the cd account is: {cd_interest_earned:,.2f}")
